...
<script type = "text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".cardhuabo").click(function(){
            ...
            if(count ==0 && ${recordedCardAmount==0}){
                ...
                var telecomCardForm = document.getElementById("telecomCardForm");
                telecomCardForm.action = "card/chooseTransferCustomer.do"
                telecomCardForm.submit();
            }
        });
        ...
        $(".cardhuishou").click(function () {
            ...
            if(count ==0 && ${recordedCardAmount==0}){
                ...
                var telecomCardForm = document.getElementById("telecomCardForm");
                telecomCardForm.action = "card/chooseRecoverCard.do"
                telecomCardForm.submit();
            }
        });
    ...
    function ChaXun() {
        ...
        var telecomCardForm = document.getElementById("telecomCardForm");
        page.value = 1;
        telecomCardForm.action = "card/queryCardInfoByCondition.do";
        telecomCardForm.submit();
    }
    function FirstPage() {
        var page = document.getElementById("page");
        var telecomCardForm = document.getElementById("telecomCardForm");
        page.value = 1;
        telecomCardForm.action = actionx;
        telecomCardForm.submit();
    }
...
<form id = "telecomCardForm" method = "get" class="layui-form">
    <div class = "hzsjtitle">您现在的位置：电信卡片</div>
    <div class = "cardbg">
        <div class = "layui-form-item">
            <div class = "layui-input-inline"><input type = "text" id = "startICCID" name = "startICCID" placeholder="ICCID" class="layui-input" autocomplete="off" style="width: 200px;" value="${queryCardCondition.startICCID}"/></div>
            <div class="layui-form-mid">-</div>
            <div class = "layui-input-inline"><input type = "text" id = "endICCID" name="endICCID" placeholder="ICCID" class="layui-input" style="width: 200px;" value="${queryCardCondition.endICCID}"></div>
        ...
        <input type="text" name = "server" value = "1" style="display: none;"/>
        <div id = "higherseek1" class="layui-form-item">
            <div class="layui-inline">
                <div class="layui-input-inline " style = "width: 100px">
                    <select  name = "select0" id = "select0">
                        <option  class = "layui-bg-blue" value="0">按订单号</option>
                        <option  value="1">按商家</option>
                        <option  value="2">按IMEI</option>
                        <option  value="3">按备注</option>
                    </select>
                </div>
                <div class="layui-input-inline " style = "width: 200px"> <input type = "text" name = "input0" placeholder="关键词" class="layui-input" value="${queryCardCondition.input0}"/></div>
                ...
                <div class = "layui-input-inline"><input type="date" name = "input1" class = "layui-input" style="width: 150px" value="${queryCardCondition.input1}"/></div>
            </div>
            <br>
            <div class="layui-input-inline " style = "width: 100px">
                <select>
        ...
        <div class = "table1">
            <table border="1px" cellspacing="0" class="layui-table">
                ...
                <c:forEach items = "${cardDisplayInfoList}" var = "telecomCard" >
                    <tr>
                        <td width="150px" align="center"><input type="checkbox" name = "ICCID" value = "${telecomCard.ICCID}" lay-ignore/>&nbsp;</td>
                        <td width="150px" align="center">${telecomCard.ICCID}</td>
                        <td width="150px" align="center">${telecomCard.business_number}</td>
                        <td width="150px" align="center">${telecomCard.user_storeName}</td>
                        <td width="150px" align="center">${telecomCard.set_name}</td>
                        <td width="150px" align="center">${telecomCard.start_time}到${telecomCard.end_time}</td>
                        <td width="150px" align="center">${telecomCard.setStatus}</td>
                        <td width="150px" align="center" class = "${telecomCard.ICCID}">${telecomCard.remark}</td>
                        <td width="150px" align="center"><input type = "button" value = "详情"  class = "layui-btn layui-btn-primary layui-btn-xs"  style="cursor: pointer"onclick="CardXQ('${telecomCard.ICCID}')" /></td>
                    </tr>
                </c:forEach>
...
<script type = "text/javascript">
    checkOption('select0','${queryCardCondition.select0}');
    checkOption('select1','${queryCardCondition.select1}');
</script>
</body>
