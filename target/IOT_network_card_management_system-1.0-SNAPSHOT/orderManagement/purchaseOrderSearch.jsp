...
<script type = "text/javascript">
    ...
    function ChaXun() {
        ...
        if(startID=="" && endID ==""){
            ...
            var PurchaseOrderForm = document.getElementById("PurchaseOrderForm");
            page.value = 1;
            PurchaseOrderForm.action = "trade/queryTradeInfoByCondition.do";
    ...
    function FirstPage() {
        ...
        var PurchaseOrderForm = document.getElementById("PurchaseOrderForm");
        page.value = 1;
        PurchaseOrderForm.action = actionx;
        PurchaseOrderForm.submit();
    }
...
<form id = "PurchaseOrderForm" class = "layui-form">
    <div class = "hzsjtitle">您现在的位置：卡片购买订单</div>
    <div class = "cardbg">
        <div class = "layui-form-item">
            <div class = "layui-input-inline"><input type = "text" name = "startID" id = "startID" placeholder="订单号" class="layui-input" value="${queryTradeCondition.startID}"/></div>
            <div class="layui-form-mid">-</div>
            <div class = "layui-input-inline"><input type = "text" name = "endID" id="endID" placeholder="订单号" class="layui-input" value = "${queryTradeCondition.endID}"></div>
        ...
        <div id = "higherseek1" class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline"><input type = "text" placeholder="关键词" name = "input0" class = "layui-input" value = "${queryTradeCondition.input0}"/></div>
                <div class="layui-input-inline " style = "width: 100px">
                ...
                <div class="layui-input-inline"><input type = "date" name = "startCharge_time" class = "layui-input" value = "${queryTradeCondition.startCharge_time}"/></div>
                <div class="layui-form-mid">-</div>
                <div class = "layui-input-inline"><input type = "date" value = "${queryTradeCondition.endCharge_time}" name = "endCharge_time" class = "layui-input"/></div>
            </div>
        </div>
        ...
        <div id = "orderTable">
            <table border="1px" cellspacing="0" class="layui-table">
                <tr>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">订单编号</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">运营商</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">所属商家</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">卡片数量</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">订单金额</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">购买时间</td>
                    <td style="width: 250px;" align="center" bgcolor="#f0f8ff">受理时间</td>
                </tr>
                <c:forEach items="${tradeDisplayInfoList}" var="tradeDisplayInfo">
                    <tr>
                        ...
                        <td style = "width: 250px;" align="center">
                            <c:if test="${tradeDisplayInfo.server == 0 }">移动</c:if>
                            <c:if test="${tradeDisplayInfo.server == 1 }">电信</c:if>
                            <c:if test="${tradeDisplayInfo.server == 2 }">联通</c:if>
                        </td>
                        ...
                        <td style="width: 250px;" align="center">
                            <c:if test="${tradeDisplayInfo.status == 0}">未受理</c:if>
                            <c:if test="${tradeDisplayInfo.status == 1}">${tradeDisplayInfo.processing_time}</c:if></td>
                    </tr>
                </c:forEach>
            </table>
...
<script type = "text/javascript">
    checkOption('status','${queryTradeCondition.status}');
    checkOption('select0','${queryTradeCondition.select0}');
    checkOption('server','${queryTradeCondition.server}');
</script>
</body>
</html>
