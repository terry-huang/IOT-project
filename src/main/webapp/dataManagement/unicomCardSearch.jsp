...
<script type = "text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".cardhuabo").click(function(){
            ...
            if(count ==0 && ${recordedCardAmount==0}){
                ...
                var unicomCardForm = document.getElementById("unicomCardForm");
                unicomCardForm.action = "card/chooseTransferCustomer.do"
                unicomCardForm.submit();
            }
        });
        ...
        $(".cardhuishou").click(function () {
            ...
            if(count ==0 && ${recordedCardAmount==0}){
                ...
                var unicomCardForm = document.getElementById("unicomCardForm");
                unicomCardForm.action = "card/chooseRecoverCard.do"
                unicomCardForm.submit();
            }
        });
    ...
    function ChaXun() {
        ...
        if(startICCID=="" && endICCID ==""){
            ...
            var unicomCardForm = document.getElementById("unicomCardForm");
            page.value = 1;
            unicomCardForm.action = "card/queryCardInfoByCondition.do";
            unicomCardForm.submit();
        }
    }
    function FirstPage() {
...
<form id = "unicomCardForm" method = "get" class="layui-form">
    <div class = "hzsjtitle">您现在的位置：联通卡片</div>
    <div class = "cardbg">
        ...
        <input type="text" name = "server" value = "2" style="display: none;"/>
        ...
        <div class = "table1">
            <table border="1px" cellspacing="0" class="layui-table">
                ...
                <c:forEach items = "${cardDisplayInfoList}" var = "unicomCard" >
                    <tr>
                        <td width="150px" align="center"><input type="checkbox" name = "ICCID" value = "${unicomCard.ICCID}" lay-ignore/>&nbsp;</td>
                        <td width="150px" align="center">${unicomCard.ICCID}</td>
                        <td width="150px" align="center">${unicomCard.business_number}</td>
                        <td width="150px" align="center">${unicomCard.user_storeName}</td>
                        <td width="150px" align="center">${unicomCard.set_name}</td>
                        <td width="150px" align="center">${unicomCard.start_time}到${unicomCard.end_time}</td>
                        <td width="150px" align="center">${unicomCard.setStatus}</td>
                        <td width="150px" align="center" class = "${unicomCard.ICCID}">${unicomCard.remark}</td>
                        <td width="150px" align="center"><input type = "button" value = "详情"  class = "layui-btn layui-btn-primary layui-btn-xs"  style="cursor: pointer"onclick="CardXQ('${unicomCard.ICCID}')" /></td>
                    </tr>
                </c:forEach>
