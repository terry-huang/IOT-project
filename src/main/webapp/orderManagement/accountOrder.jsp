...
<form id = "accountOrderForm" class = "layui-form">
    ...
    <div class = "cardbg">
        <div class = "layui-form-item">
            <div class = "layui-input-inline"><input type = "text" id = "startID" name = "startID" placeholder="订单号" class = "layui-input"/></div>
            <div class="layui-form-mid">-</div>
            <div class = "layui-input-inline"><input type = "text" id = "endID" name="endID" placeholder="订单号" class = "layui-input"></div>
        ...
        <div id = "higherseek1" class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline"><input type = "text" placeholder="充值金额" name = "startCharge_trade" class="layui-input"/></div>
                <div class="layui-form-mid">-</div>
                <div class = "layui-input-inline"><input type = "text" placeholder="充值金额" name = "endCharge_trade" class="layui-input"/></div>&nbsp;&nbsp;&nbsp;
                ...
                <c:forEach items="${accountTradeList}" var="accountTrade">
                    <tr>
                        ...
                        <td style="width: 250px;" align="center">
                            ...
                            <c:if test="${accountTrade.status == 0}"><input type = "button" value = "处理" onclick="accountXQ(${accountTrade.ID})" class="layui-btn layui-btn-primary layui-btn-xs"></c:if>
                        </td>
                    </tr>
                </c:forEach>
