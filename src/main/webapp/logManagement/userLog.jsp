...
<div style="display: none" id = "test">
    <table border="1" class = "layui-table"  lay-size="sm">
        <tr>
            <td width="150px" bgcolor="skyblue" style = "font-weight:bold ">登录账号</td>
            <td width="150px" id = "name"></td>

            <td width="150px" bgcolor="skyblue" style = "font-weight:bold ">登陆密码</td>
            <td width="150px" id = "password"></td>
        </tr>
        <tr>
            <td bgcolor="skyblue" style = "font-weight:bold ">用户所属公司</td>
            <td id = "company"></td>
            <td bgcolor="skyblue" style = "font-weight:bold ">用户真实姓名</td>
            <td id = "realName"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td bgcolor="skyblue" style = "font-weight:bold ">用户身份证</td>
            <td id = "IDNumber"></td>
...
<form id = "userLogForm" method="get" class = "layui-form">
    ...
    <div class = "cardbg">
        <div class = "layui-form-item">
            <div class = "layui-input-inline"><input type="text" placeholder="请输入用户编号" name = "startID" id="startID" class = "layui-input"></div>
            <div class="layui-form-mid">-</div>
            <div class = "layui-input-inline"><input type="text" placeholder="请输入用户编号" name = "endID" id = "endID" class = "layui-input"></div>
            ...
            <div id = "higherseek1" class="layui-form-item">
                ...
                <div class = "layui-input-inline"><input type = "text" placeholder="请输入店铺名称" id = "storeName" name = "storeName" class = "layui-input"></div>
            </div>
            </div>
        <br>
        <div id = "orderTable">
